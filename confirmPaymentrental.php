...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" id="services" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-dark-grey"><b>CONFIRM PAYMENT</b></h1>
...
$query = "SELECT * FROM rentalbooking WHERE rentalbookingID = '$idURL'";
...
?>
<form method="post" action="insertPaymentrental.php">
<table width="500">
<tr>
<td><b>Hour:</b><br>
<input type ="number" name="hour" size="11" value="<?php echo $hour; ?>" readonly></td>
 <tr>
<td><b>Amount (RM):</b><br>
...
<input type ="hidden" name="rentalbookingID" value="<?php echo $idURL; ?>">
<input type ="hidden" name="driverID" value="<?php echo $driverID; ?>">
<input type ="hidden" name="CustomerID" value="<?php echo $CustomerID; ?>">
<input type ="hidden" name="taxibookingID" value="NULL">
<br>
