...
?>
 <form method="post" action="insertRentalBooking.php">
 <tr>
...
<tr>
<td><b>Plate No :</b><br>
<input type ="text" name="platNo" size="11" value="<?php echo $registrationNo; ?>" readonly></td>
<br>
<br>
<td><b>Driver ID:</b><br>
<input type ="number" name="driverID" size="11" value="<?php echo $driverID; ?>" readonly></td>
<br>
<br>
...
<input type ="date" name="bookingDate" size="11" value="<?php echo $bookingDate; ?>" ></td>
<br>
<br>
<td><b>Insert Time:</b><br>
<input type ="time" name="bookingTime" size="11" value="<?php echo $bookingTime; ?>" ></td>
<br>
<br>
<form name="hour" method="post" action="rentingForm.php">
        <input type="hidden" name="hour" value="nohour" />
        <label ><b>Hour :</b></label><br><br>
        <select name="hour" onchange="calculatePrice(this.value)" required>
        ...
        <br><br><label><b>Price (RM)</b></label>
        <input class="w3-input w3-border" name="price" id="price" type="number" value="<?php echo $price; ?>" readonly>
        <script>
