...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" id="section-driver" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-dark-grey"><b>REPORT</b></h1>
    <hr style="width:50px;border:5px solid black" class="w3-round">
    <form>
	<table align="center", cellpadding="50">
	<tr>
		<td><input class="button" type="button" value="Annual Report" onclick="window.location.href='AnnualReport.php'" /></td>
		<td><input class="button" type="button" value="Monthly Report" onclick="window.location.href='MonthlyReport.php'" /></td>
		<td><input class="button" type="button" value="Daily Report" onclick="window.location.href='DailyReport.php'" /></td>
	  </tr>
	</table>
	</form>
  </div>
