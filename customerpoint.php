...
<h1 class="w3-xxxlarge w3-text-dark-grey"><b>POINT & REWARD</b></h1>
...
if (mysqli_num_rows($result) > 0){
    ...
    ?>
                <div>
                <label for="points"><h4><b>Point Collected:</b></h4></label> 
                <input type ="text" name="point" size="25" value="<?php echo $points; ?>">
                </div>

<?php
    }
} else {
    echo "NO POINT COLLECTED!";
